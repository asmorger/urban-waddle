...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+-------------+----------+-----------+------------|                         |--------------+-----------+----------+----------+------------+
LT(_WINNAV,KC_A),      KC_S,      KC_D,       KC_F,        KC_G,                             TD(DANCE_3),       KC_J,LT(4, KC_K),LT(_NAV, KC_L),    KC_SCLN,
  //|--------+-------------+----------+-----------+------------|                         |--------------+-----------+----------+----------+------------+
         KC_Z,         KC_X,      KC_C,TD(DANCE_2),        KC_B,                                    KC_N,TD(DANCE_4),   KC_COMM,    KC_DOT,     KC_LEAD,
  //|--------+-------------+----------+-----------+------------+--------------|  |--------+-------------+-----------+----------+----------+------------+|
                                   MT(MOD_MEH,KC_SPACE), OSM(MOD_LSFT),    OSM(MOD_RCTL),  OSL(_SYM)
                                     //`--------------------------------------'  `--------------------------------'
  ...
  //|--------+--------+--------+--------+--------+---------|  |--------+--------+--------+--------+--------+--------+|
                                            TO(_QWERTY), KC_LSFT,     SELWORD,   TO(_NAV)
                             //`---------------------------'  `--------------------------'
  ),
  [_NAV] = LAYOUT_split_3x5_2(
  //,----------------------------------------------.                    ,--------------------------------------------------------------.
       RESET,  KC_PGUP,    KC_UP,  _______, _______,                 TO(_COLEMAK), TO(_QWERTY), _______,       _______,             _______,
  //|-------+---------+---------+---------+--------|                    |--------+--------+--------+--------+--------+--------|
  ...
  //|--------+--------+--------+--------+--------+---------|  |--------+--------+--------+--------+--------+--------+|
                                            TO(_QWERTY), KC_LSFT,     KC_LGUI,   ENTRTN
                             //`---------------------------'  `--------------------------'
  ),
  ...
  //|--------+-------------+----------+-----------+------------|                         |--------------+-----------+----------+----------+------------+
         KC_A,         KC_R,      KC_S,       KC_T,        KC_G,                                    KC_M,       KC_N,LT(4, KC_E),LT(3, KC_I),      KC_O,
  //|--------+-------------+----------+-----------+------------|                         |--------------+-----------+----------+----------+------------+
         KC_Z,         KC_X,      KC_C,       KC_D,        KC_V,                                    KC_K,       KC_H,   KC_COMM,    KC_DOT,     KC_LEAD,
  //|--------+-------------+----------+-----------+------------+--------------|  |--------+-------------+-----------+----------+----------+------------+|
                                   MT(MOD_MEH,KC_SPACE), OSM(MOD_LSFT),    OSM(MOD_RCTL),  OSL(1)
                                     //`--------------------------------------'  `--------------------------------'
  ),
  [_WINNAV] = LAYOUT_split_3x5_2(
  //,---------------------------------------------.                    ,---------------------------------------------.
     _______, _______, _______, _______,  _______,                      _______, DESKTOP1,DESKTOP2,DESKTOP3, _______,
  //|--------+--------+--------+--------+---------|                    |--------+--------+--------+--------+--------+|
